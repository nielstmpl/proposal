...
window.PROPOSAL_CONFIG = {
  ...
  hal9: {
    ...
    items: [
      { letter: "A", title: "Donasi Uang Tunai", desc: "Bantuan dana tunai untuk kebutuhan operasional kegiatan: lomba, jalan santai, konsumsi, perlengkapan, dan malam puncak." },
